...
contract BoosterSaleGenesis is Pausable, AccessControl {
  ...
  ERC20 public immutable genesisBooster;
  ...
  constructor(
    ...
    mht = _mht;
    genesisBooster = _genesisBooster;
    price = _price;
  }
  ...
  function buy(uint256 _numberOfBoosters) public whenNotPaused {
    ...
    genesisBooster.safeTransferFrom(boosterOwner, msg.sender, _numberOfBoosters);
  }
